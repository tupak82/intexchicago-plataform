...
export type LegacyQueryRedirect = LegacyRedirect & {
  queryKey: string;
  queryValue: string;
};
...
export const legacyRedirects: LegacyRedirect[] = [
  { source: "/side-navigation/stormdamage/", destination: "/storm-damage-restoration-chicago/", permanent: true, note: "Verified legacy navigation route: Storm Damage" },
  { source: "/side-navigation/waterdamage/", destination: "/water-damage-restoration-chicago/", permanent: true, note: "Verified legacy navigation route: Water Damage" },
  { source: "/trauma-cleaning-biohazard-removal/", destination: "/trauma-biohazard-cleaning-chicago/", permanent: true, note: "Verified legacy navigation route: Trauma Cleaning" },
  { source: "/side-navigation/firedamage/", destination: "/fire-damage-restoration-chicago/", permanent: true, note: "Verified legacy navigation route: Fire Damage" },
...
// Query-string URLs need Next.js `has` conditions instead of a plain path map.
// `/?page_id=12534` is a confirmed indexed legacy Trauma/Biohazard page.
export const legacyQueryRedirects: LegacyQueryRedirect[] = [
  {
    source: "/",
    ...
    queryKey: "page_id",
    queryValue: "12534",
    note: "Confirmed indexed legacy WordPress page_id route",
  },
];
